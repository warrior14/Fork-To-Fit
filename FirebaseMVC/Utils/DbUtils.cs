...
namespace ForkToFit.Utils
{
    /// <summary>
    ///  A set of useful helper methods for interacting with ADO.NET and handling null values if any:
    /// </summary>
    public static class DbUtils
    {
        ...
        // method to post either a object with a value or a DBNull value to the database:
